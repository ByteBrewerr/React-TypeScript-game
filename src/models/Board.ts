...
class Board {
 ...
 public getThisBoardCell(cell: Cell): Cell{
  ...
  public addCharacters(){
    ...
    this.addCharacter(2,11, new Zombie(Teams.Computer, 711))
    this.addCharacter(3,11, new Lich(Teams.Computer, 121))
    this.addCharacter(5,11, new Wrath(Teams.Computer, 317))
    this.addCharacter(6,11, new BoneDragon(Teams.Computer, 23))
